      ...
      <div className="mx-auto max-w-6xl px-4 grid md:grid-cols-2 gap-10 items-center">
        <div className="space-y-6">
          ...
          <div className="flex gap-3">
            <a href="#lead-form"><Button className="h-11 px-6 rounded-full">Get Your {state} Cash Offer</Button></a>
        ...
        <div className="relative aspect-[4/3] md:aspect-[5/4] rounded-2xl border bg-card shadow-sm">
